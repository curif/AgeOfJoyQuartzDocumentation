...
The utility will generate a file named `AgeOfJoy_BugReport_YYYYMMDD_HHMMSS.zip` located in your root `AgeOfJoy` data folder. This package is comprehensive and contains:
...
*   **Configurations & Scripts:** A full copy of your `.yaml` configuration files, your AGEBasic `.bas` scripts, and any `.debug` crash reports generated by the interpreter.
